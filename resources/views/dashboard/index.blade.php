  ...
  <div class="container d-flex justify-content-center py-5 mt-5">
    <div class="card-profile">
      <div class="d-flex align-items-center "> <img src="/images/peter.jpg" class="img profile-image rounded-pill"
        ...
        <div class="ms-5">
          <h5 class="text-dark m-font fw-bold">Peter Parker <small class="text-muted ms-2 fw-normal xs-font">Student</small>
          </h5>
  ...
  <div class="container mb-5 py-5 text-center mx-auto content">
    ...
    <div class="row py-4 justify-content-center">
      @foreach ($featureList as $feature)
        <div class="card-profile feature col-md-3 col-sm-6 mb-2 p-2 m-2 align-items-center" style="max-width: 170px">
          <a href="/dashboard/{{ $feature['slug'] }}">
            <img class="bd-placeholder-img mt-2" width="50" height="50" src="/images/icons/{{ $feature['icon'] }}" />
