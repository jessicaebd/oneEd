            ...
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                ...
                <div class="col-lg-6">
                    <p>
                        ...
                        /
                        <a href="" class="text-blue">{{ $course['category'] }}</a>
                    </p>
                    <h1 class="display-5 fs-3 fw-bold lh-1 mb-3">{{ $course['title'] }}</h1>

                    <small class="text-muted">
                        <a href="#" class="text-decoration-none text-muted">{{ $course['mentorName'] }}</a>
                        |
                        <i class="bi bi-hourglass-split"></i> {{ $course['duration'] }} weeks long
                    </small>

                    <p class="lead fs-5">{{ $course['description'] }}</p>
