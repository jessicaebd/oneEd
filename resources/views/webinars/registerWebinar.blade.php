        ...
        <div class="container-fluid mt-5 pt-5 pb-4 bg-grey" style="min-height: 1000px;">
            <div class="row flex-lg-row py-5 justify-content-center">
                ...
                <div class="card mb-3 bg-light justify-content-center"
                    ...
                    <h1 class="display-5 fs-1 fw-bold lh-1 mb-3 text-center">{{ $webinar['title'] }}</h1>
                    ...
                    <h1 class="text-blue l-font fw-bold">You have successfully registered to this webinar!</h1>
                    <hr>

                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault">
                        <label class="form-check-label" for="flexSwitchCheckDefault">Remind me for webinar's event
                            date</label>
                    </div>

                    <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-3">
                        <a href="/webinars" class="btn btn-main btn-custom mt-auto fw-bolder"
