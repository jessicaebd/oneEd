        ...
        <div class="card chat-app">
            ...
            <ul class="list-unstyled chat-list mt-2 mb-0">
              @foreach ($webinarList->take(1) as $webinar)
                <li class="clearfix active">
                  <img src="/images/webinar/{{ $webinar['poster'] }}" alt="avatar" class="rounded-circle" width="50"
                    height="50">
          ...
          <div class="chat">
            ...
            <div class="chat-header clearfix">
              <div class="row">
                <div class="col-lg-11">
                  <img src="/images/webinar/webinar-1.jpeg" alt="avatar" class="rounded-circle border border-secondary"
                    width="45" height="45">
              ...
              <ul class="m-b-0">
                ...
                <li class="clearfix">
                  ...
                  <div class="message my-message" style="background-color: rgb(202, 247, 202);">Hi! You
                    ...
                    link
                    <span class="text-primary"><u>bit.ly/webinar23</u></span>
                  </div>
                </li>
              </ul>
            </div>
